...
- Assessment run ID | معرّف تشغيل التقييم: `run-b61d1af8d46d4c17`
- Generated UTC | وقت الإنشاء: 2026-09-22T08:50:52.390775+00:00
...
- Median latency | وسيط الزمن: 2.702 ms
...
- Before | قبل: 6.713 ms / 500 iterations
- After | بعد: 0.397 ms / 500 iterations
- Cache hits / misses | إصابات / إخفاقات التخزين: 499 / 1
- Learner trade-off and guardrail | مقايضة وضابط المتدرب: trade_off: الكاش قد يحتفظ بسياسة قديمة إذا تغير الإصدار — قبل الكاش: 6.713ms بعد الكاش: 0.397ms | guardrail: مفتاح الكاش يحتوي رقم الإصدار active_policy_version=2026.1 حتى يتجدد تلقائياً عند أي تغيير — cache_hits=499
